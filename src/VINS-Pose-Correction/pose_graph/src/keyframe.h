...
#define MIN_LOOP_NUM 25 //VII-B中经过去除误匹配后剩余的最少内点数量
...
public:
	...
	bool has_loop;//该关键帧是不是属于回环帧
	int loop_index;//以匹配上的之前关键帧的序号赋值的，不是按照从0开始的
	Eigen::Matrix<double, 8, 1 > loop_info;//包括窗口中的回环帧与对应的之前关键帧之间的相对位姿和relative_yaw
};
